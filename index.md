...
1. **AI as the New Abstraction for Data Systems**: Vibe coding, Context Engineering, Harness Engineering.
2. **Foundations of Data Systems**: Data models, big data storage and retrieval, and how to encode information when you store data. 
3. **Scaling Distributed Systems**: Cluster, cloud, edge, network, replication, partition, consistency, ACID.
4. **Data Processing and Programming model**: Batch processing, stream processing, MapReduce, Hadoop, Spark, Kafka.
...
**Lectures**: TuTh 3:30PM-4:50PM; PODEM 1A19
